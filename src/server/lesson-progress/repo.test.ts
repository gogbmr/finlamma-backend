...
// not a mock - proves the unique (user_id, lesson_id) constraint and the
// never-downgrade-on-conflict behavior actually hold at the database level.
// Never touches the real Supabase database (see @/db/client's
// NODE_ENV=test guard).
